...
import com.bitcli.mcp.mention.AtMentionCompleter;
...
final class BitCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    BitCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
