...
import com.bitcli.tui.history.ConversationSnapshot;
import com.bitcli.tui.pane.CenterPane;
import com.bitcli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final BitCliConfig config;
    ...
    public TuiSessionController(BitCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "bitcli-tui-agent-runner");
