package com.bitcli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bitcli] stdout reader stopped: " + e.getMessage());
            }
        }, "bitcli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bitcli] stderr reader stopped: " + e.getMessage());
            }
        }, "bitcli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
