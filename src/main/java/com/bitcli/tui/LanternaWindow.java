...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(BitCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("Bit CLI v16.0.0");
