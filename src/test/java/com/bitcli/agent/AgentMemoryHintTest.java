...
import com.bitcli.llm.GLMClient;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("bitcli.memory.dir");
        System.setProperty("bitcli.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("bitcli.memory.dir");
            } else {
                System.setProperty("bitcli.memory.dir", oldMemoryDir);
            }
        }
    }
