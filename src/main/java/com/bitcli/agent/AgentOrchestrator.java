...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.bitcli.skill.SkillRegistry skillRegistry,
                               com.bitcli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "bitcli-multi-agent");
            t.setDaemon(true);
            return t;
        });
