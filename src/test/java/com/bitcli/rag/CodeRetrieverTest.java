...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/bitcli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("bitcli.rag.dir", "/tmp/bitcli-test-rag-retriever");
