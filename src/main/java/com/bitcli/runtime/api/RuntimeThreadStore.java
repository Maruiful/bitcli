...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("bitcli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("BITCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".bitcli", "runtime").toString();
        }
